...
#python3 demo.py 2> stderr.txt
#python3 demo.py >golden_stdout.txt 2>golden_stderr.txt
make 
./${BENCHMARK} 2> stderr.txt
./${BENCHMARK} >golden_stdout.txt 2>golden_stderr.txt 
cd $CWD
