...
xxd /home/carol/pedro/fi/nvbit_release/tools/nvbitfi/test-apps/cudaTensorCoreGemm/stdout > stdout.hex
touch diff.log 

# comparing stdout generated by your program
diff stdout.hex ${APP_DIR}/golden_stdout.hex > stdout_diff.log
...
grep sum stdout.hex > selected_output.txt 
grep sum ${APP_DIR}/golden_stdout.hex > selected_golden_output.txt 
